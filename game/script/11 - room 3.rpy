...
{color=#fff}A set{/color} is made up of {color=#fff}[toynumber] unique toys.{/color} You can reach toys {color=#fff}by moving up, down, left, or right.{/color} You {color=#fff}can't move diagonally.{/color}
...
label scrapbook_game_over:
    ...
    $ Achievement.add(achievement_dead10)
...
label toys_game_over:
    ...
    $ Achievement.add(achievement_dead12)
...
label cooking_game_over:
    ...
    $ Achievement.add(achievement_dead13)
