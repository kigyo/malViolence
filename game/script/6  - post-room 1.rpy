...
#### confirmation sound - yay, you won room 1!
  ...
  c "So,{w=0.1} what did you think of our—{w=1.25}{nw}"
  ...
  c "But never fear!"
  show cautionne hairtwirl
  c "The Great Cautionne,{w=0.1} Emperor of MalViolence,{w=1.25}{nw}" 
  c "used his aptitude for adaptation to his advantage."
  show cautionne lean speaking
  c "And so,{w=0.1} he constructed these quasi-deadly puzzle rooms,{w=1.25}{nw}"
