...
label start:
    ...
    "(GAH! What the-)"
    "(...Huh? Where are you?)"
    #[pause – camera moves to show them looking around] 
    ...
    "(Oh, over there! "
    #(NB: “extend” is used when I want a movement to happen in between sentences) 
    #[camera moves to the CRT TV in the corner] 
