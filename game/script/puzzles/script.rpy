...
label room_2_puzzle_3:
    call init_cybernetics from _call_init_cybernetics_1
...
label room_3_puzzle_2:
    call init_toy_board from _call_init_toy_board_1
...
label room_3_puzzle_3:
    call init_mise_en_place from _call_init_mise_en_place_2
