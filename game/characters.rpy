...
define xd = Character(_("???"), color="#00e7ff", image="drdanger", callback=speaker("drdanger"), ctc="ctc", ctc_position="nestled-close")
...
define dr = Character(_("Dr. Danger"), voice_tag="drdanger", color="#ffffff", image="drdanger", callback=speaker("drdanger"), ctc="ctc", ctc_position="nestled-close")
